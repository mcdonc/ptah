...
from ptah.cms import interfaces

from .app import ApplicationRoot
from .forms import AddForm
from .uiactions import list_uiactions

view.static('cmsapp', 'static')
...
view.register_layout(
    ...
    template = view.template("templates/layout-ptahsecurity.pt"))
...
listing_template = view.template("templates/listing.pt")
